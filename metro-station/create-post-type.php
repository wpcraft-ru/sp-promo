...
function thorny_register_metro_post_type(){
	$name = 'Маршруты';
	$singularName = 'Маршрут';
	$addSingularName = 'Маршрут';
	...
	$labels = array(
		...
		,'new_item' => 'Новый '.$singularName // текст новой записи
...
add_action('init', 'thorny_register_metro_post_type');